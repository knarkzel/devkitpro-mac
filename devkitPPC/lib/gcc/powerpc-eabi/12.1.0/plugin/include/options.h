...
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_P9_MINMAX (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_P9_MISC (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_P9_VECTOR (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_PREFIXED (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1U << 46)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1U << 47)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1U << 48)
...
#define TARGET_EXPLICIT_DIRECT_MOVE_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_DIRECT_MOVE) != 0)
#define SET_TARGET_DIRECT_MOVE(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_DIRECT_MOVE
/* DLMZB mask */
...
enum opt_code
{
  ...
  OPT__param_rs6000_density_load_num_threshold_ = 284,/* --param=rs6000-density-load-num-threshold= */
  OPT__param_rs6000_density_load_pct_threshold_ = 285,/* --param=rs6000-density-load-pct-threshold= */
  OPT__param_rs6000_density_pct_threshold_ = 286,/* --param=rs6000-density-pct-threshold= */
  OPT__param_rs6000_density_penalty_ = 287,  /* --param=rs6000-density-penalty= */
  OPT__param_rs6000_density_size_threshold_ = 288,/* --param=rs6000-density-size-threshold= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 289,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 290,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 291,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 292,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 293, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 294,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 295,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 296,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 297,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 298,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 299,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 300, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 301,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 302,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 303,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 304,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 305,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 306,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 307,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 308,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 309,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 310,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 311,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 312,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 313,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 314,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 315,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_threader_debug_ = 316,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 317,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 318,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 319, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 320,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 321,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 322,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 323, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 324,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 325,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 326,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 327,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 328,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 329, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 330,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 331,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 332,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 333,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 334,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 335,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 336,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 337,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 338,    /* --param=vect-induction-float= */
  ...
  OPT_Wtrivial_auto_var_init = 798,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 799,                           /* -Wtsan */
  ...
  OPT_m32 = 1770,                            /* -m32 */
  OPT_m64 = 1771,                            /* -m64 */
  OPT_mabi_altivec = 1772,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1773,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1774,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1775,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1776,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1777,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1778,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1779,                /* -mabi=no-altivec */
  OPT_mabi_vec_default = 1780,               /* -mabi=vec-default */
  OPT_mabi_vec_extabi = 1781,                /* -mabi=vec-extabi */
  OPT_mads = 1782,                           /* -mads */
  OPT_maix_struct_return = 1783,             /* -maix-struct-return */
  OPT_malign_ = 1784,                        /* -malign- */
  OPT_malign_branch_targets = 1785,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 1786,             /* -mallow-movmisalign */
  OPT_maltivec = 1787,                       /* -maltivec */
  OPT_malways_hint = 1788,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1789,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1790,                           /* -mbig */
  OPT_mbig_endian = 1791,                    /* -mbig-endian */
  OPT_mbit_align = 1792,                     /* -mbit-align */
  OPT_mbit_word = 1793,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1794,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 1795,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 1796,      /* -mblock-move-inline-limit= */
  OPT_mblock_ops_unaligned_vsx = 1797,       /* -mblock-ops-unaligned-vsx */
  OPT_mblock_ops_vector_pair = 1798,         /* -mblock-ops-vector-pair */
  OPT_mbss_plt = 1799,                       /* -mbss-plt */
  OPT_mcall_ = 1800,                         /* -mcall- */
  OPT_mcmpb = 1801,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1802,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1803,                          /* -mcpu= */
  OPT_mcrypto = 1804,                        /* -mcrypto */
  OPT_mdebug_ = 1805,                        /* -mdebug= */
  OPT_mdirect_move = 1806,                   /* -mdirect-move */
  OPT_mdlmzb = 1807,                         /* -mdlmzb */
  OPT_meabi = 1808,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1809,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1810,                           /* -memb */
  OPT_mfloat128 = 1811,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1812,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1813,             /* -mfloat128-hardware */
  OPT_mfp_in_toc = 1814,                     /* -mfp-in-toc */
  OPT_mfprnd = 1815,                         /* -mfprnd */
  OPT_mfriz = 1816,                          /* -mfriz */
  OPT_mfull_toc = 1817,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1818, */              /* -mfused-madd */
  OPT_mgcbios = 1819,                        /* -mgcbios */
  OPT_mgcn = 1820,                           /* -mgcn */
  /* OPT_mgen_cell_microcode = 1821, */      /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 1822,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1823,                      /* -mhard-dfp */
  OPT_mhard_float = 1824,                    /* -mhard-float */
  OPT_mhtm = 1825,                           /* -mhtm */
  OPT_mieee128_constant = 1826,              /* -mieee128-constant */
  OPT_minsert_sched_nops_ = 1827,            /* -minsert-sched-nops= */
  OPT_misel = 1828,                          /* -misel */
  OPT_mlittle = 1829,                        /* -mlittle */
  OPT_mlittle_endian = 1830,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1831,                  /* -mlong-double- */
  OPT_mlongcall = 1832,                      /* -mlongcall */
  /* OPT_mlra = 1833, */                     /* -mlra */
  OPT_mmfcrf = 1834,                         /* -mmfcrf */
  OPT_mmfpgpr = 1835,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1836,                   /* -mminimal-toc */
  OPT_mmma = 1837,                           /* -mmma */
  OPT_mmodulo = 1838,                        /* -mmodulo */
  OPT_mmulhw = 1839,                         /* -mmulhw */
  OPT_mmultiple = 1840,                      /* -mmultiple */
  OPT_mmvme = 1841,                          /* -mmvme */
  OPT_mnewlib = 1842,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1843,                  /* -mno-fp-in-toc */
  /* OPT_mno_mfpgpr = 1844, */               /* -mno-mfpgpr */
  /* OPT_mno_string = 1845, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1846,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1847,                        /* -mno-toc */
  OPT_mno_traceback = 1848,                  /* -mno-traceback */
  OPT_mno_update = 1849,                     /* -mno-update */
  OPT_mogc = 1850,                           /* -mogc */
  OPT_moptimize_swaps = 1851,                /* -moptimize-swaps */
  OPT_mpcrel = 1852,                         /* -mpcrel */
  OPT_mpcrel_opt = 1853,                     /* -mpcrel-opt */
  OPT_mpltseq = 1854,                        /* -mpltseq */
  OPT_mpointers_to_nested_functions = 1855,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1856,                       /* -mpopcntb */
  OPT_mpopcntd = 1857,                       /* -mpopcntd */
  OPT_mpower10 = 1858,                       /* -mpower10 */
  OPT_mpower10_fusion = 1859,                /* -mpower10-fusion */
  OPT_mpower8_fusion = 1860,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1861,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1862,                 /* -mpower8-vector */
  OPT_mpower9_minmax = 1863,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1864,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1865,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1866, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1867,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1868,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1869,                     /* -mpowerpc64 */
  OPT_mprefixed = 1870,                      /* -mprefixed */
  OPT_mprioritize_restricted_insns_ = 1871,  /* -mprioritize-restricted-insns= */
  OPT_mprivileged = 1872,                    /* -mprivileged */
  OPT_mprototype = 1873,                     /* -mprototype */
  OPT_mquad_memory = 1874,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1875,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 1876,             /* -mreadonly-in-sdata */
  OPT_mrecip = 1877,                         /* -mrecip */
  OPT_mrecip_precision = 1878,               /* -mrecip-precision */
  OPT_mrecip_ = 1879,                        /* -mrecip= */
  OPT_mregnames = 1880,                      /* -mregnames */
  OPT_mrelative_jumptables = 1881,           /* -mrelative-jumptables */
  OPT_mrelocatable = 1882,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1883,               /* -mrelocatable-lib */
  OPT_mrop_protect = 1884,                   /* -mrop-protect */
  OPT_mrvl = 1885,                           /* -mrvl */
  OPT_msave_toc_indirect = 1886,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1887,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1888,                  /* -msched-epilog */
  OPT_msched_groups = 1889,                  /* -msched-groups */
  OPT_msched_prolog = 1890,                  /* -msched-prolog */
  OPT_msdata = 1891,                         /* -msdata */
  OPT_msdata_ = 1892,                        /* -msdata= */
  OPT_msecure_plt = 1893,                    /* -msecure-plt */
  OPT_mshlib = 1894,                         /* -mshlib */
  OPT_msim = 1895,                           /* -msim */
  OPT_msingle_pic_base = 1896,               /* -msingle-pic-base */
  OPT_msoft_float = 1897,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 1898,      /* -mspeculate-indirect-jumps */
  OPT_msplat_float_constant = 1899,          /* -msplat-float-constant */
  OPT_msplat_word_constant = 1900,           /* -msplat-word-constant */
  OPT_mstack_protector_guard_offset_ = 1901, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1902,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1903,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1904,                  /* -mstrict-align */
  OPT_mstring = 1905,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1906,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1907,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1908,            /* -msvr4-struct-return */
  OPT_mtls_size_ = 1909,                     /* -mtls-size= */
  OPT_mtoc = 1910,                           /* -mtoc */
  OPT_mtraceback_ = 1911,                    /* -mtraceback= */
  OPT_mtune_ = 1912,                         /* -mtune= */
  OPT_munroll_only_small_loops = 1913,       /* -munroll-only-small-loops */
  OPT_mupdate = 1914,                        /* -mupdate */
  OPT_mveclibabi_ = 1915,                    /* -mveclibabi= */
  OPT_mvgc = 1916,                           /* -mvgc */
  OPT_mvrsave = 1917,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1918, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1919, */              /* -mvrsave=yes */
  OPT_mvsx = 1920,                           /* -mvsx */
  OPT_mvsx_align_128 = 1921,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 1922, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1923,             /* -mwarn-altivec-long */
  OPT_mxl_compat = 1924,                     /* -mxl-compat */
  OPT_myellowknife = 1925,                   /* -myellowknife */
  OPT_n = 1926,                              /* -n */
