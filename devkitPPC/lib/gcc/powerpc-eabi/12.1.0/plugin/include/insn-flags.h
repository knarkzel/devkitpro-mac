...
#define HAVE_packif_soft ((FLOAT128_2REG_P (IFmode) && TARGET_SOFT_FLOAT) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_packtd_soft ((FLOAT128_2REG_P (TDmode) && TARGET_SOFT_FLOAT) && (TARGET_HARD_FLOAT))
...
#define HAVE_sldoi_to_movv4si (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V4SImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv8hi (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V8HImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv16qi (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V16QImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv4sf (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V4SFmode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv2df (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V2DFmode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv2di (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V2DImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv1ti (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movti (VECTOR_UNIT_ALTIVEC_OR_VSX_P (TImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movkf ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (KFmode) && can_create_pseudo_p ()) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_sldoi_to_movtf ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (TFmode) && can_create_pseudo_p ()) && (FLOAT128_VECTOR_P (TFmode)))
...
#define HAVE_altivec_vmrghw_direct_v4sf (TARGET_ALTIVEC)
#define HAVE_altivec_vmrghw_direct_v4si (TARGET_ALTIVEC)
#define HAVE_altivec_vmrglb_direct (TARGET_ALTIVEC)
#define HAVE_altivec_vmrglh_direct (TARGET_ALTIVEC)
#define HAVE_altivec_vmrglw_direct_v4sf (TARGET_ALTIVEC)
#define HAVE_altivec_vmrglw_direct_v4si (TARGET_ALTIVEC)
...
extern rtx        gen_packif_soft                       (rtx, rtx, rtx);
extern rtx        gen_packtd_soft                       (rtx, rtx, rtx);
...
extern rtx        gen_altivec_vmrghw_direct_v4sf        (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghw_direct_v4si        (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglb_direct             (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglh_direct             (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4sf        (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4si        (rtx, rtx, rtx);
